...
import org.example.springboot.rpc.core.Enum.ProtocolMessageStatusEnum;
import org.example.springboot.rpc.core.Enum.ProtocolMessageTypeEnum;
import org.example.springboot.rpc.core.http.tcp.TcpBufferHandlerWrapper;
...
//        netSocket.handler(buffer -> {
        TcpBufferHandlerWrapper bufferHandlerWrapper = new TcpBufferHandlerWrapper(buffer->{
            ...
            BeanUtil.copyProperties(protocolMessage.getHeader(), header);
            try {
                // 获取要调用的服务实现类，通过反射调用
